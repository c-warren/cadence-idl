...
type StartTimerDecisionAttributes struct {
	...
	// priority is a client hint that lets the resulting timer task be executed with
	// deprioritized (async) scheduling. Optional; defaults to normal execution.
	Priority             TaskPriority `protobuf:"varint,3,opt,name=priority,proto3,enum=uber.cadence.api.v1.TaskPriority" json:"priority,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}
...
func (m *StartTimerDecisionAttributes) GetPriority() TaskPriority {
	if m != nil {
		return m.Priority
	}
	return TaskPriority_TASK_PRIORITY_INVALID
}
...
type StartChildWorkflowExecutionDecisionAttributes struct {
	...
	CronOverlapPolicy            CronOverlapPolicy             `protobuf:"varint,16,opt,name=cron_overlap_policy,json=cronOverlapPolicy,proto3,enum=uber.cadence.api.v1.CronOverlapPolicy" json:"cron_overlap_policy,omitempty"`
	ActiveClusterSelectionPolicy *ActiveClusterSelectionPolicy `protobuf:"bytes,17,opt,name=active_cluster_selection_policy,json=activeClusterSelectionPolicy,proto3" json:"active_cluster_selection_policy,omitempty"`
	// priority is a client hint that lets the resulting start-child-workflow task be
	// executed with deprioritized (async) scheduling. Optional; defaults to normal.
	Priority             TaskPriority `protobuf:"varint,18,opt,name=priority,proto3,enum=uber.cadence.api.v1.TaskPriority" json:"priority,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}
...
func (m *StartChildWorkflowExecutionDecisionAttributes) GetPriority() TaskPriority {
	if m != nil {
		return m.Priority
	}
	return TaskPriority_TASK_PRIORITY_INVALID
...
var fileDescriptor_fb529b236ea74dc2 = []byte{
	...
	,
}
...
func (m *StartTimerDecisionAttributes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Priority != 0 {
		i = encodeVarintDecision(dAtA, i, uint64(m.Priority))
		i--
		dAtA[i] = 0x18
	}
...
func (m *StartTimerDecisionAttributes) Size() (n int) {
	...
	if m.Priority != 0 {
		n += 1 + sovDecision(uint64(m.Priority))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *StartChildWorkflowExecutionDecisionAttributes) Size() (n int) {
	...
	if m.Priority != 0 {
		n += 2 + sovDecision(uint64(m.Priority))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Priority |= TaskPriority(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
