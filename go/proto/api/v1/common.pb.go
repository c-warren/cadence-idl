...
// TaskPriority is a client-supplied hint about how latency-sensitive the internal
// tasks produced by a decision are. It lets a client opt work into deprioritized
// (async) execution so that, under backlog, Cadence yields scheduling capacity to
// higher-priority work.
//
// TASK_PRIORITY_ASYNC is the only value that currently changes server behavior;
// the HIGH/DEFAULT/LOW values are reserved for future use and are treated like
// TASK_PRIORITY_INVALID (server default) today.
type TaskPriority int32

const (
	// Unset. The server applies its normal runtime-computed priority.
	TaskPriority_TASK_PRIORITY_INVALID TaskPriority = 0
	// Reserved for future use. Treated as TASK_PRIORITY_INVALID today.
	TaskPriority_TASK_PRIORITY_HIGH TaskPriority = 1
	// Reserved for future use. Treated as TASK_PRIORITY_INVALID today.
	TaskPriority_TASK_PRIORITY_DEFAULT TaskPriority = 2
	// Reserved for future use. Treated as TASK_PRIORITY_INVALID today.
	TaskPriority_TASK_PRIORITY_LOW TaskPriority = 3
	// Deprioritized (async) execution. Under backlog these tasks yield scheduling
	// slots to higher-priority work; when workers are idle they still run promptly.
	TaskPriority_TASK_PRIORITY_ASYNC TaskPriority = 4
)

var TaskPriority_name = map[int32]string{
	0: "TASK_PRIORITY_INVALID",
	1: "TASK_PRIORITY_HIGH",
	2: "TASK_PRIORITY_DEFAULT",
	3: "TASK_PRIORITY_LOW",
	4: "TASK_PRIORITY_ASYNC",
}

var TaskPriority_value = map[string]int32{
	"TASK_PRIORITY_INVALID": 0,
	"TASK_PRIORITY_HIGH":    1,
	"TASK_PRIORITY_DEFAULT": 2,
	"TASK_PRIORITY_LOW":     3,
	"TASK_PRIORITY_ASYNC":   4,
}

func (x TaskPriority) String() string {
	return proto.EnumName(TaskPriority_name, int32(x))
}
...
func init() {
	...
	proto.RegisterEnum("uber.cadence.api.v1.TaskPriority", TaskPriority_name, TaskPriority_value)
...
var fileDescriptor_0ff151d4a308b356 = []byte{
	...
	,
}
