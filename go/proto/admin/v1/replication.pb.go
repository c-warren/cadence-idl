...
// HistoryTaskDLQTaskKey identifies a task within a history task DLQ partition.
type HistoryTaskDLQTaskKey struct {
	VisibilityTimestamp  *types.Timestamp `protobuf:"bytes,1,opt,name=visibility_timestamp,json=visibilityTimestamp,proto3" json:"visibility_timestamp,omitempty"`
...
func (m *HistoryTaskDLQTaskKey) Reset()         { *m = HistoryTaskDLQTaskKey{} }
func (m *HistoryTaskDLQTaskKey) String() string { return proto.CompactTextString(m) }
func (*HistoryTaskDLQTaskKey) ProtoMessage()    {}
func (*HistoryTaskDLQTaskKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_90118d56a5f1c507, []int{12}
}
func (m *HistoryTaskDLQTaskKey) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *HistoryTaskDLQTaskKey) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_HistoryTaskDLQTaskKey.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *HistoryTaskDLQTaskKey) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HistoryTaskDLQTaskKey.Merge(m, src)
}
func (m *HistoryTaskDLQTaskKey) XXX_Size() int {
	return m.Size()
}
func (m *HistoryTaskDLQTaskKey) XXX_DiscardUnknown() {
	xxx_messageInfo_HistoryTaskDLQTaskKey.DiscardUnknown(m)
}

var xxx_messageInfo_HistoryTaskDLQTaskKey proto.InternalMessageInfo

func (m *HistoryTaskDLQTaskKey) GetVisibilityTimestamp() *types.Timestamp {
	if m != nil {
...
func (m *HistoryTaskDLQTaskKey) GetTaskId() int64 {
	if m != nil {
		return m.TaskId
	}
	return 0
...
// CountHistoryTaskDLQTasks fans out across shards and returns one entry per matching
// partition; the caller sums the counts to get a total length.
type HistoryTaskDLQCountEntry struct {
	ShardId               int32    `protobuf:"varint,1,opt,name=shard_id,json=shardId,proto3" json:"shard_id,omitempty"`
	DomainId              string   `protobuf:"bytes,2,opt,name=domain_id,json=domainId,proto3" json:"domain_id,omitempty"`
...
func (m *HistoryTaskDLQCountEntry) Reset()         { *m = HistoryTaskDLQCountEntry{} }
func (m *HistoryTaskDLQCountEntry) String() string { return proto.CompactTextString(m) }
func (*HistoryTaskDLQCountEntry) ProtoMessage()    {}
func (*HistoryTaskDLQCountEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_90118d56a5f1c507, []int{13}
}
func (m *HistoryTaskDLQCountEntry) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *HistoryTaskDLQCountEntry) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_HistoryTaskDLQCountEntry.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *HistoryTaskDLQCountEntry) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HistoryTaskDLQCountEntry.Merge(m, src)
}
func (m *HistoryTaskDLQCountEntry) XXX_Size() int {
	return m.Size()
}
func (m *HistoryTaskDLQCountEntry) XXX_DiscardUnknown() {
	xxx_messageInfo_HistoryTaskDLQCountEntry.DiscardUnknown(m)
}

var xxx_messageInfo_HistoryTaskDLQCountEntry proto.InternalMessageInfo

func (m *HistoryTaskDLQCountEntry) GetShardId() int32 {
	if m != nil {
		return m.ShardId
	}
	return 0
...
func (m *HistoryTaskDLQCountEntry) GetDomainId() string {
	if m != nil {
		return m.DomainId
	}
	return ""
...
func (m *HistoryTaskDLQCountEntry) GetClusterAttributeScope() string {
	if m != nil {
...
func (m *HistoryTaskDLQCountEntry) GetClusterAttributeName() string {
	if m != nil {
...
func (m *HistoryTaskDLQCountEntry) GetTaskCategory() int32 {
	if m != nil {
...
func (m *HistoryTaskDLQCountEntry) GetCount() int64 {
	if m != nil {
		return m.Count
	}
	return 0
...
type HistoryTaskDLQAckLevel struct {
	ShardId                     int32            `protobuf:"varint,1,opt,name=shard_id,json=shardId,proto3" json:"shard_id,omitempty"`
	DomainId                    string           `protobuf:"bytes,2,opt,name=domain_id,json=domainId,proto3" json:"domain_id,omitempty"`
	ClusterAttributeScope       string           `protobuf:"bytes,3,opt,name=cluster_attribute_scope,json=clusterAttributeScope,proto3" json:"cluster_attribute_scope,omitempty"`
	ClusterAttributeName        string           `protobuf:"bytes,4,opt,name=cluster_attribute_name,json=clusterAttributeName,proto3" json:"cluster_attribute_name,omitempty"`
	TaskCategory                int32            `protobuf:"varint,5,opt,name=task_category,json=taskCategory,proto3" json:"task_category,omitempty"`
	AckLevelVisibilityTimestamp *types.Timestamp `protobuf:"bytes,6,opt,name=ack_level_visibility_timestamp,json=ackLevelVisibilityTimestamp,proto3" json:"ack_level_visibility_timestamp,omitempty"`
	AckLevelTaskId              int64            `protobuf:"varint,7,opt,name=ack_level_task_id,json=ackLevelTaskId,proto3" json:"ack_level_task_id,omitempty"`
	XXX_NoUnkeyedLiteral        struct{}         `json:"-"`
	XXX_unrecognized            []byte           `json:"-"`
	XXX_sizecache               int32            `json:"-"`
}

func (m *HistoryTaskDLQAckLevel) Reset()         { *m = HistoryTaskDLQAckLevel{} }
func (m *HistoryTaskDLQAckLevel) String() string { return proto.CompactTextString(m) }
func (*HistoryTaskDLQAckLevel) ProtoMessage()    {}
func (*HistoryTaskDLQAckLevel) Descriptor() ([]byte, []int) {
	return fileDescriptor_90118d56a5f1c507, []int{14}
}
func (m *HistoryTaskDLQAckLevel) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *HistoryTaskDLQAckLevel) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_HistoryTaskDLQAckLevel.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *HistoryTaskDLQAckLevel) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HistoryTaskDLQAckLevel.Merge(m, src)
}
func (m *HistoryTaskDLQAckLevel) XXX_Size() int {
	return m.Size()
}
func (m *HistoryTaskDLQAckLevel) XXX_DiscardUnknown() {
	xxx_messageInfo_HistoryTaskDLQAckLevel.DiscardUnknown(m)
}

var xxx_messageInfo_HistoryTaskDLQAckLevel proto.InternalMessageInfo

func (m *HistoryTaskDLQAckLevel) GetShardId() int32 {
	if m != nil {
		return m.ShardId
	}
	return 0
...
func (m *HistoryTaskDLQAckLevel) GetDomainId() string {
	if m != nil {
		return m.DomainId
	}
	return ""
...
func (m *HistoryTaskDLQAckLevel) GetClusterAttributeScope() string {
	if m != nil {
		return m.ClusterAttributeScope
	}
	return ""
...
func (m *HistoryTaskDLQAckLevel) GetClusterAttributeName() string {
	if m != nil {
		return m.ClusterAttributeName
	}
	return ""
...
func (m *HistoryTaskDLQAckLevel) GetTaskCategory() int32 {
	if m != nil {
		return m.TaskCategory
	}
	return 0
...
func (m *HistoryTaskDLQAckLevel) GetAckLevelVisibilityTimestamp() *types.Timestamp {
	if m != nil {
		return m.AckLevelVisibilityTimestamp
	}
	return nil
}

func (m *HistoryTaskDLQAckLevel) GetAckLevelTaskId() int64 {
	if m != nil {
		return m.AckLevelTaskId
	}
	return 0
}

// HistoryTaskDLQTask is a single task stored in a history task DLQ partition.
type HistoryTaskDLQTask struct {
	DomainId              string                 `protobuf:"bytes,1,opt,name=domain_id,json=domainId,proto3" json:"domain_id,omitempty"`
	...
	TaskKey               *HistoryTaskDLQTaskKey `protobuf:"bytes,5,opt,name=task_key,json=taskKey,proto3" json:"task_key,omitempty"`
	Task                  []byte                 `protobuf:"bytes,6,opt,name=task,proto3" json:"task,omitempty"`
	XXX_NoUnkeyedLiteral  struct{}               `json:"-"`
	XXX_unrecognized      []byte                 `json:"-"`
	XXX_sizecache         int32                  `json:"-"`
}

func (m *HistoryTaskDLQTask) Reset()         { *m = HistoryTaskDLQTask{} }
func (m *HistoryTaskDLQTask) String() string { return proto.CompactTextString(m) }
func (*HistoryTaskDLQTask) ProtoMessage()    {}
func (*HistoryTaskDLQTask) Descriptor() ([]byte, []int) {
	return fileDescriptor_90118d56a5f1c507, []int{15}
}
func (m *HistoryTaskDLQTask) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *HistoryTaskDLQTask) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_HistoryTaskDLQTask.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *HistoryTaskDLQTask) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HistoryTaskDLQTask.Merge(m, src)
}
func (m *HistoryTaskDLQTask) XXX_Size() int {
	return m.Size()
}
func (m *HistoryTaskDLQTask) XXX_DiscardUnknown() {
	xxx_messageInfo_HistoryTaskDLQTask.DiscardUnknown(m)
}

var xxx_messageInfo_HistoryTaskDLQTask proto.InternalMessageInfo

func (m *HistoryTaskDLQTask) GetDomainId() string {
	if m != nil {
		return m.DomainId
	}
	return ""
...
func (m *HistoryTaskDLQTask) GetClusterAttributeScope() string {
	if m != nil {
		return m.ClusterAttributeScope
	}
	return ""
...
func (m *HistoryTaskDLQTask) GetClusterAttributeName() string {
	if m != nil {
		return m.ClusterAttributeName
	}
	return ""
...
func (m *HistoryTaskDLQTask) GetTaskCategory() int32 {
	if m != nil {
		return m.TaskCategory
	}
	return 0
...
func (m *HistoryTaskDLQTask) GetTaskKey() *HistoryTaskDLQTaskKey {
	if m != nil {
		return m.TaskKey
	}
	return nil
...
func (m *HistoryTaskDLQTask) GetTask() []byte {
	if m != nil {
		return m.Task
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*HistoryTaskDLQTaskKey)(nil), "uber.cadence.admin.v1.HistoryTaskDLQTaskKey")
	proto.RegisterType((*HistoryTaskDLQCountEntry)(nil), "uber.cadence.admin.v1.HistoryTaskDLQCountEntry")
	proto.RegisterType((*HistoryTaskDLQAckLevel)(nil), "uber.cadence.admin.v1.HistoryTaskDLQAckLevel")
	proto.RegisterType((*HistoryTaskDLQTask)(nil), "uber.cadence.admin.v1.HistoryTaskDLQTask")
}
...
var fileDescriptor_90118d56a5f1c507 = []byte{
	...
	,
}
...
func (m *HistoryTaskDLQTaskKey) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *HistoryTaskDLQTaskKey) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HistoryTaskDLQTaskKey) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *HistoryTaskDLQCountEntry) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *HistoryTaskDLQCountEntry) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HistoryTaskDLQCountEntry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.TaskCategory != 0 {
		i = encodeVarintReplication(dAtA, i, uint64(m.TaskCategory))
		i--
		dAtA[i] = 0x28
	}
	if len(m.ClusterAttributeName) > 0 {
		...
		i = encodeVarintReplication(dAtA, i, uint64(len(m.ClusterAttributeName)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.ClusterAttributeScope) > 0 {
		...
		i = encodeVarintReplication(dAtA, i, uint64(len(m.ClusterAttributeScope)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.DomainId) > 0 {
...
func (m *HistoryTaskDLQAckLevel) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *HistoryTaskDLQAckLevel) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HistoryTaskDLQAckLevel) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.AckLevelTaskId != 0 {
		i = encodeVarintReplication(dAtA, i, uint64(m.AckLevelTaskId))
		i--
		dAtA[i] = 0x38
	}
	if m.AckLevelVisibilityTimestamp != nil {
		{
			size, err := m.AckLevelVisibilityTimestamp.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *HistoryTaskDLQTask) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *HistoryTaskDLQTask) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HistoryTaskDLQTask) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Task) > 0 {
		i -= len(m.Task)
		copy(dAtA[i:], m.Task)
		i = encodeVarintReplication(dAtA, i, uint64(len(m.Task)))
		i--
		dAtA[i] = 0x32
	}
	if m.TaskKey != nil {
		{
			size, err := m.TaskKey.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *HistoryTaskDLQTaskKey) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *HistoryTaskDLQCountEntry) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.TaskCategory != 0 {
		n += 1 + sovReplication(uint64(m.TaskCategory))
	}
	if m.Count != 0 {
		n += 1 + sovReplication(uint64(m.Count))
	}
...
func (m *HistoryTaskDLQAckLevel) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.AckLevelVisibilityTimestamp != nil {
		l = m.AckLevelVisibilityTimestamp.Size()
		n += 1 + l + sovReplication(uint64(l))
	}
	if m.AckLevelTaskId != 0 {
		n += 1 + sovReplication(uint64(m.AckLevelTaskId))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *HistoryTaskDLQTask) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *HistoryTaskDLQTaskKey) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HistoryTaskDLQTaskKey: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HistoryTaskDLQTaskKey: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *HistoryTaskDLQCountEntry) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HistoryTaskDLQCountEntry: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HistoryTaskDLQCountEntry: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *HistoryTaskDLQAckLevel) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HistoryTaskDLQAckLevel: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HistoryTaskDLQAckLevel: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AckLevelVisibilityTimestamp", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.AckLevelVisibilityTimestamp == nil {
				m.AckLevelVisibilityTimestamp = &types.Timestamp{}
			}
			if err := m.AckLevelVisibilityTimestamp.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AckLevelTaskId", wireType)
			}
			m.AckLevelTaskId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.AckLevelTaskId |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *HistoryTaskDLQTask) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HistoryTaskDLQTask: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HistoryTaskDLQTask: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 5:
			...
			if m.TaskKey == nil {
				m.TaskKey = &HistoryTaskDLQTaskKey{}
			}
			if err := m.TaskKey.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
